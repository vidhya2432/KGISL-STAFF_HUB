              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  ...
                  <Select value={assignmentType} onValueChange={setAssignmentType}>
                    <SelectTrigger className="rounded-full py-6 text-black font-bold"><SelectValue placeholder="Select type..." /></SelectTrigger>
                    <SelectContent className="rounded-2xl bg-white text-black">
                      <SelectItem value="Case Study" className="focus:bg-[#f5f5f7] focus:text-black text-black font-bold">Case Study</SelectItem>
                      <SelectItem value="Research Paper" className="focus:bg-[#f5f5f7] focus:text-black text-black font-bold">Research Paper</SelectItem>
                      <SelectItem value="Problem Set" className="focus:bg-[#f5f5f7] focus:text-black text-black font-bold">Problem Set</SelectItem>
                      <SelectItem value="Essay" className="focus:bg-[#f5f5f7] focus:text-black text-black font-bold">Essay</SelectItem>
                      <SelectItem value="Practical Lab Report" className="focus:bg-[#f5f5f7] focus:text-black text-black font-bold">Practical Lab Report</SelectItem>
                    </SelectContent>
                  </Select>
        ...
        <TabsContent value="submissions" className="space-y-6 mt-6">
          <Card className="rounded-[32px] border-[#d2d2d7] shadow-sm"><CardHeader className="flex flex-row items-center justify-between"><div><CardTitle className="text-2xl font-semibold text-[#1d1d1f]">Grading Hub</CardTitle><CardDescription className="text-base">Track submissions and AI analysis.</CardDescription></div><div className="flex gap-4">
            <Select value={activeAssignmentId} onValueChange={setActiveAssignmentId}>
              ...
              <SelectContent className="rounded-2xl bg-white text-black">
                {assignments.map(a => <SelectItem key={a.id} value={a.id} className="focus:bg-[#f5f5f7] focus:text-black text-black font-bold">{a.title}</SelectItem>)}
              </SelectContent>
            </Select>
